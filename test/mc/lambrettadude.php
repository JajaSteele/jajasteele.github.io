<?php
	...
	//checking the server
	$response=MCPing::check('84.105.22.115', 25565, 1);
...
<html>
    <head>
        ...
        <meta property="og:description" content="Quick status page for Lambrettadude's Minecraft server." />
    ...
    <body>
        <div style="background:#0e1334;color:#fff;text-align:center;padding:1px 1px 0px 1px;">
            <p style="position:relative;top:0px;font-size:70px;font-family: 'Upheaval TT (BRK)'; src: url('upheavtt.ttf');">Status Page for Lambrettadude's server</p>
